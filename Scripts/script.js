...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        ...
        ar: {
            ...
            'p1-title': 'متجر موبيل', 'p2-title': 'دليل المستوردين', 'p3-title': 'كودزوكا', 'p4-title': 'وصفات التصنيع', 'p5-title': 'سكاي تكس', 'p6-title': 'بورتيجي', 'p7-title': 'الأخوة', 'p8-title': 'دبلن الماسية', 'p9-title': 'إي ماركتينج', 'p10-title': 'المدينة', 'p11-title': 'إكس تيم', 'p12-title': 'موقع إخباري', 'p13-title': 'أورجانيك', 'p14-title': 'بوابة الاستثمار', 'p15-title': 'دوبامين','p16-title': 'يامي فود','p17-title':'ريتش مايندز','p-18':'كلية أكسفورد',
